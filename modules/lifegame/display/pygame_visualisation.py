...
image_cell_full = PygameImage(getcwd()+'/modules/lifegame/display/pygame/cha3.png')
image_cell_medium = PygameImage(getcwd()+'/modules/lifegame/display/pygame/cha2.png')
image_cell_small = PygameImage(getcwd()+'/modules/lifegame/display/pygame/cha.png')
image_cell_dead = PygameImage(getcwd()+'/modules/lifegame/display/pygame/cha0.png')
